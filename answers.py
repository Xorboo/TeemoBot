...
class Answers:
    ...
    role_answers = {
        ...
        'Grandmaster': [
            ', теперь ты Grandmaster!',
            ', почти чалик!',
            ', у нас тут грандмастер есть!'
        ],
        'Challenger': [
    ...
    role_comments = {
        ...
        'Iron': [
            'Как ты умудрился вообще?',
            'Чалик в душе, рак в руках.',
            'You Are Special!'
        ],
        'Bronze': [
    ...
    banned_trolling = [
        "... Произнес {0} со стороны параши",
        "... Закукарекал {0}",
        "{0}, че раскукарекался то?",
        "{0}, хватит вякать",
        "Чуете, завоняло чем-то?",
        "{0} порвался, лол",
        "О, {0} главная вниманиевхора треда",
        "{0} так и говори, что насливал в своей бронзе",
        "{0} так и говори, что насливал",
        "{0} страдай, хули",
        "{0}, не опоздай в школу",
        "{0}, плз",
        "А ты смешной, {0}",
        "{0}, как бы тебе сказать, братишка...",
        "{0}, ты наркоман?",
        "{0}, ну если ты кроме кудах-кудах ничего не видишь, то это печально.",
        "{0}, ты унылый, токсичный и слился, астанавись уже.",
        "{0}, теперь осталось только выяснить зачем ты это написал.",
        "{0}, ты что несешь, поехавший?",
        "Этот краб сломался, несите нового",
        "{0}, не ной, тряпка",
        "{0}, хватит тут каментики постить, пошли уже в постельку, мой сладенький"
    ]
    ...
    @staticmethod
    def get_banned_trolling():
        return random.choice(Answers.banned_trolling)
